...
- Keep Kakomu, its global capture shortcut, and managed OCR workers available from the system tray after the main window is closed.
...
- Add native sidecar packaging, hardened Electron fuses, branded app assets, and cross-platform release automation.
- Add Electron process tests for the preload bridge, private API, persistent storage, navigation, desktop controls, and narrow layouts.
