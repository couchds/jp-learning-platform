...
- The API launcher prefers the packaged macOS overlay app when present, then falls back to `services/desktop-overlay/.venv/bin/python`; the Runtime Doctor mirrors that expectation.
