...
- The API launcher prefers the packaged macOS overlay app on macOS when present, then falls back to the platform virtual environment Python path and system Python commands; the Runtime Doctor mirrors that expectation.
